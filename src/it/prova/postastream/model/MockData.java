...
public class MockData {
	...
	static {
		...
		PostaDiPaese secondaPosta = new PostaDiPaese(2L, "secondaPosta", "Via Minetti 3", LocalDate.of(2010, 04, 11), 10);
		...
		PostaDiPaese quartaPosta = new PostaDiPaese(4L, "quartaPosta", "Via orto 13", LocalDate.of(2011, 04, 11), 60);
